...
class HopMatchRule(object):
    ...
    def __init__(self, edge_rule=None, adjacent_vertex_rule=None, local_vars_configuration=None):  # noqa: E501
    ...
    def edge_rule(self, edge_rule):
        ...
        :type: EdgeMatchRule
        """
        if self.local_vars_configuration.client_side_validation and edge_rule is None:  # noqa: E501
            raise ValueError("Invalid value for `edge_rule`, must not be `None`")  # noqa: E501
