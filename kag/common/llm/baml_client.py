...
@LLMClient.register("BAML")
@LLMClient.register("baml")
class BAMLClient(LLMClient):
    """
    A client class for interacting with the BAML Library.

    This class provides methods to make requests to the BAML Library.
    """
