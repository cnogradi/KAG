...
@PromptABC.register("baml_deduce_multi_choice")
class DeduceMutiChoice(PromptABC):
    ...
    def parse_response(self, response: str, **kwargs):
        response = b.DeduceMultiChoice(kwargs['instruction'], kwargs['memory'])
        logger.debug("Reasoner judgment:{}".format(response))
        return response.no_available_information, response.option
